...
export default function CompanySearch({ selectedCompany, onSelect, onDelete, index }) {
  const [isLoading, setIsLoading] = useState(false);
  // const [companies, setCompanies] = useState([]); // initialized to []
  ...
  const getOptionLabel = (option) =>
    option ? `${option.Code} - ${option.Name} (${option["Long Name"] || "N/A"})` : "";
  ...
  return (
    ...
    renderInput={(params) => (
      <TextField {...params} label="Search by Code or Name" variant="outlined" />
    )}
    sx={{
      width: {
        xs: '100%',     // 📱 0px to 600px: full width
        sm: '400px',    // 📱 600px to 900px: 400px width
        md: '500px',    // 💻 900px and above: 500px width
      },
      maxWidth: '100%', // 💡 Always prevent overflow
    }}
  />
